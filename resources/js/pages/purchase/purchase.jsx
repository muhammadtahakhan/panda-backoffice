...
import { deletePurchaseOrder, fetchPurchaseOrders, showForm, hideForm } from "../../redux/purchaseOrderSlice";
...
export default function Purchase() {
    ...
    const items = [
        ...
        // },
        {
            ...
            command: () => {
                console.log("selected", selectedRow.rowData.id);
                dispatch(deletePurchaseOrder(selectedRow.rowData.id));
            },
        },
    ];
    ...
    const onPageChange = (event) => {
        dispatch(fetchPurchaseOrders(event.page + 1, event.rows));
    };
    ...
    return (
        <>
            <SiteTitle>Purchase</SiteTitle>

            <PageTitle>Purchase Listing</PageTitle>
            ...
            <div className="card flex justify-content-center">
                <Dialog
                    position={"right"}
                    header="Create Purchase Order/ پرچیز آرڈر بنائیں"
